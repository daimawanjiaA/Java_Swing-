...
import main.java.handler.Adminhandler.SonPatienthandler.PatientIfoHandler;
...
public class PatientIfo extends JFrame {
    ...
    //监听器
    PatientIfoHandler patientIfoHandler = new PatientIfoHandler(this);
    ...
    public PatientIfo() {
        ...
        //设置监听器
        addBtn.addActionListener(patientIfoHandler);
        delBtn.addActionListener(patientIfoHandler);
        updateBtn.addActionListener(patientIfoHandler);
        searchBtn.addActionListener(patientIfoHandler);
        returnBtn.addActionListener(patientIfoHandler);
        printBtn.addActionListener(patientIfoHandler);
    ...
    private void layoutCenter(Container contentPane) {
        ...
        PatientIfoAction patientIfo = new PatientIfoAction();
        data = patientIfo.getData();
