...
import main.java.handler.Adminhandler.SonEMRhandler.SonEmrUpdateHandler;

import javax.swing.*;
import java.awt.*;

public class AdminEmrUpdate extends JDialog {

    public Boolean flag = false;
    Container container;
    SpringLayout springLayout = new SpringLayout();
    JPanel jPanel = new JPanel(springLayout);
    JLabel MRno = new JLabel("请输入病历号：");
    ...
    SonEmrUpdateHandler emrUpdateHandler = new SonEmrUpdateHandler(this);

    public AdminEmrUpdate(JFrame jFrame, String str1, boolean bool) {
