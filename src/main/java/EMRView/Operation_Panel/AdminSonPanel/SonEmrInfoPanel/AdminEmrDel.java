...
import main.java.handler.Adminhandler.SonEMRhandler.SonEmrDeleteHandler;

import javax.swing.*;
import java.awt.*;

public class AdminEmrDel extends JDialog {
    public Boolean flag = false;

    JLabel Dno = new JLabel("请输入病历号: ");
    ...
    SonEmrDeleteHandler deleteHandler;

    public AdminEmrDel(JFrame jfram, String str, boolean bool) {
        super(jfram, str, bool);
        //设置监听器
        deleteHandler = new SonEmrDeleteHandler(this);
