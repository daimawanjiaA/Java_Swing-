...
import main.java.handler.Adminhandler.SonPatienthandler.SonPatientAddHandler;

import javax.swing.*;
import java.awt.*;

public class AdminPatientAdd extends JDialog {
    ...
    SonPatientAddHandler sonPatientAddHandler = new SonPatientAddHandler(this);

    public AdminPatientAdd(JFrame jFrame, String str1, boolean bool) {
        ...
        jPanel.add(Cancel);
        //加入监听器
        Submit.addActionListener(sonPatientAddHandler);
        Cancel.addActionListener(sonPatientAddHandler);
        //设置组件字体
        ...
        springLayout.putConstraint(springLayout.WEST, Pno, 90, springLayout.WEST, jPanel);
        ...
        //Pname
        springLayout.putConstraint(springLayout.NORTH, Pname, 50, springLayout.NORTH, Pno);
