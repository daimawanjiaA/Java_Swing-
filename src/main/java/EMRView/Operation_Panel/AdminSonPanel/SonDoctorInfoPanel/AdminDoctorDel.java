...
import main.java.handler.Adminhandler.SonDoctorhandler.SonDoctorDeleteHandler;

import javax.swing.*;
import java.awt.*;


public class AdminDoctorDel extends JDialog {
    ...
    SonDoctorDeleteHandler deleteHandler;

    public AdminDoctorDel(JFrame jfram, String str, boolean bool) {
        super(jfram, str, bool);


        //设置监听器
        deleteHandler = new SonDoctorDeleteHandler(this);
