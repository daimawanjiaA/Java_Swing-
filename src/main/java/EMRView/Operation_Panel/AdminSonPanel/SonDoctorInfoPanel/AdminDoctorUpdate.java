...
import main.java.handler.Adminhandler.SonDoctorhandler.SonDoctorUpdateHandler;

import javax.swing.*;
import java.awt.*;

public class AdminDoctorUpdate extends JDialog {
    ...
    SonDoctorUpdateHandler updateHandler = new SonDoctorUpdateHandler(this);

    public AdminDoctorUpdate(JFrame jFrame, String str1, boolean bool) {
        ...
        jPanel.add(Cancel);
        //加入监听器
        Submit.addActionListener(updateHandler);
        Cancel.addActionListener(updateHandler);
        //设置组件字体
        ...
        //设置组件位置
        //Dno
        springLayout.putConstraint(springLayout.NORTH, Dno, 20, springLayout.NORTH, jPanel);
        ...
        //Dname
        springLayout.putConstraint(springLayout.NORTH, Dname, 80, springLayout.NORTH, Dno);
    ...
    public static void main(String[] args) {
        ...
        new AdminDoctorUpdate(null, null, true);
    }
